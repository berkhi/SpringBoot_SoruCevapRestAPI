...
{
    @ExceptionHandler(SoruCevapAppException.class)
    public ResponseEntity<ErrorMessage> handleDemoException(SoruCevapAppException ex){
        ErrorType errorType = ex.getErrorType();
        return new ResponseEntity(createErrorMessage(ex),errorType.getStatus());
    }

    private ErrorMessage createErrorMessage(SoruCevapAppException ex)
    {
